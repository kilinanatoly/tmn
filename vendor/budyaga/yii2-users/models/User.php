...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['username','first_name', 'photo', 'email', 'auth_key', 'password_hash'], 'string', 'max' => 255],
            [['first_name'], 'match', 'pattern' => '/^([а-яА-ЯЁёa-zA-Z0-9]+)$/u', 'message' => 'Поле "Имя" должно содержать только русские и английские буквы.'],
            [['created_at', 'updated_at', 'status', 'sex','employment','city'], 'integer'],
            [['last_activity','birthday'], 'safe'],
    ...
    public function getPhotoss(){
        return $this->hasMany(PhotosForUser::className(),['user_id'=>'id']);
    }
}
